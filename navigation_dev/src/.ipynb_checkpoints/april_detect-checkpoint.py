...
def process_tags(detector, K, s, results, image, visualize=True):
    ...
    """
        ...
        K: intrinsic parameters (fx, fy, cx, cy) -> Vu's robot is (1615.8033976291508, 1604.188015052642, 901.2657921740209, 528.6492115797364)
...
if __name__ == "__main__":
    ...
    rospy.Subscriber("/video_source/raw", Image, cam_callback)
    rospy.Subscriber("/video_source/camera_info", CameraInfo, params_callback)
    rospy.spin()
